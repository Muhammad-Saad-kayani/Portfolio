    ...
    >
      ...
      <div className="relative z-20 flex flex-1 flex-col pt-16 gap-2">
        ...
        <p className="text-[16px] font-[400] max-w-[555px] my-4">
          ...
          including HTML, CSS, JavaScript, React.js, Next.js, and Tailwind CSS.
        </p>
        <div className="my-5 flex flex-wrap gap-5">
          ...
          <p className="font-bold lg:font-bold">1100+ <span className="text-[16px] font-[400] lg:text-[16px] lg:font-[600]">Excellent Reviews</span> </p>
        </div>
      </div>
    </section>
  );
